...
- **Now on deck:** the two verified quick fixes — focus management on view switch, and persist the level filter — then a fuller **deal-lifecycle walkthrough** and the **who's-who ecosystem map**.
